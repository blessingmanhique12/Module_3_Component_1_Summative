# Component 1 : ARRAYS AND DATA STRUCTURES
...
3. Open the browser console to confirm the `console.log()` output.
4. Open `test/test.html` in the browser.
5. ALTERNATIVELY : Run `npm test` in your terminal to see the test results.
6. The Mocha test results will appear on the page.
